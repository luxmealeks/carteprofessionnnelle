    ...
    <div class="card shadow-sm mb-4">
        <div class="card-header bg-primary text-white">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="{{ route('photos.validation') }}" class="btn btn-light btn-sm">
            ...
            <div class="row">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body p-2">
                            <div class="img-container">
                                <img id="image-to-crop" src="{{ Storage::url($agent->photo) }}" 
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="crop-form" action="{{ route('photos.update-crop', $agent->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="d-grid gap-2">
                                    ...
                                    <a href="{{ route('photos.validation') }}" class="btn btn-outline-danger">
