                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle">
                            ...
                            <tbody>
                                @forelse($lots as $lot)
                                <tr>
                                    <td class="fw-bold">{{ $lot->numero }}</td>
                                    <td>{{ $lot->inspectionAcademique->nom ?? 'N/A' }}</td>
                                        ...
                                        <div class="d-flex gap-2">
                                          {{--   <a href="{{ route('lots.edit', $lot->id) }}"
                                            ...
                                            <button type="button"
                                                    ...
                                                    data-bs-target="#deleteModal{{ $lot->id }}">
                                                Supprimer
                                            </button>
                                        </div>
                                    </td>
    ...
    <div class="modal-dialog">
        <div class="modal-content border-danger">
            <div class="modal-header bg-danger text-white">
                <h5 class="modal-title" id="deleteModalLabel{{ $lot->id }}">
            ...
            <div class="modal-body">
                <p>Êtes-vous sûr de vouloir supprimer définitivement le lot <strong>{{ $lot->numero }}</strong> ?</p>
