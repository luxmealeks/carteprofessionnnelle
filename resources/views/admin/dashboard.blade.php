                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    ...
                                    <h2 class="mb-0">{{ number_format($en_attente) }}</h2>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    ...
                                    <h2 class="mb-0">{{ number_format($validees) }}</h2>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    ...
                                    <h2 class="mb-0">{{ number_format($rejetees) }}</h2>
                                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-wrap gap-3">
                            <a href="{{ route('agents.create') }}" class="btn btn-action btn-primary">
                                <i class="bi bi-person-plus me-2"></i>Ajouter un Agent
                            </a>
                            <a href="{{ route('photos.index') }}" class="btn btn-action btn-warning">
                                <i class="bi bi-camera me-2"></i>Valider Photos
                            </a>
                            <a href="{{ route('lots.generer') }}" class="btn btn-action btn-success">
                                <i class="bi bi-files me-2"></i>Générer Lot
                            </a>
                            <a href="{{ route('ias.create') }}" class="btn btn-action btn-info">
                            ...
                            <div class="list-group-item border-0 px-0 py-3">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <div class="avatar bg-light-{{ $activity['color'] }} text-{{ $activity['color'] }}">
