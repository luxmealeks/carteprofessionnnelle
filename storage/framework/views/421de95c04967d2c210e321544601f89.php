                    ...
                    <table class="table table-hover align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="text-danger small"><?php echo e($agent->motif_rejet_photo); ?></span>
                                </td>
                                <td>
                                    <!-- Bouton pour réintégration -->
                                    <button class="btn btn-sm btn-outline-primary"
                                            data-bs-toggle="modal"
                                            data-bs-target="#reintegrerModal<?php echo e($agent->id); ?>">
                            ...
                            <div class="modal fade" id="reintegrerModal<?php echo e($agent->id); ?>" tabindex="-1" aria-hidden="true">
                                <div class="modal-dialog">
                                    <form method="POST" action="<?php echo e(route('photos.reintegrer', $agent)); ?>" class="modal-content">
                                        <?php echo csrf_field(); ?>
                                        <div class="modal-header">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/carteprofessionnnelle/resources/views/photos/rejetees.blade.php ENDPATH**/ ?>