...
<div class="container">
    <div class="card shadow-sm border-0">
        ...
        <div class="card-body">
            <form action="<?php echo e(route('agents.store')); ?>" method="POST" enctype="multipart/form-data" id="agent-form">
                <?php echo csrf_field(); ?>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="matricule" class="form-control" value="<?php echo e(old('matricule')); ?>" maxlength="20">
                        </div>

                        <div class="mb-3">
                            <label class="form-label">CIN</label>
                            <input type="text" name="cin" class="form-control" value="<?php echo e(old('cin')); ?>" maxlength="20">
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" name="date_naissance" class="form-control" value="<?php echo e(old('date_naissance')); ?>">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="tel" name="telephone" class="form-control" value="<?php echo e(old('telephone')); ?>" required>
                        </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" name="fonction" class="form-control" value="<?php echo e(old('fonction')); ?>" required>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="corps_id" class="form-select select-enhanced">
                                    ...
                                    <?php $__currentLoopData = $corps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $corpsItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($corpsItem->id); ?>" <?php echo e(old('corps_id') == $corpsItem->id ? 'selected' : ''); ?>>
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="grade_id" class="form-select select-enhanced">
                                    ...
                                    <?php $__currentLoopData = $grades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $grade): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($grade->id); ?>" <?php echo e(old('grade_id') == $grade->id ? 'selected' : ''); ?>>
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="structure_id" class="form-select" id="structure-select">
                                    ...
                                    <?php $__currentLoopData = $structures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $structure): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($structure->id); ?>" <?php echo e(old('structure_id') == $structure->id ? 'selected' : ''); ?>>
                            ...
                            <div class="col-md-4" id="inspection-wrapper">
                                ...
                                <select name="inspection_academique_id" id="inspection-select" class="form-select">
                                    ...
                                    <?php $__currentLoopData = $inspectionAcademiques; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ia): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($ia->id); ?>" <?php echo e(old('inspection_academique_id') == $ia->id ? 'selected' : ''); ?>>
                                            <?php echo e($ia->nom); ?>
    ...
    if (inspectionSelect && etablissementSelect) {
        inspectionSelect.addEventListener('change', function() {
            ...
            if (selectedIa && selectedIa.etablissements) {
                ...
                const prevValue = "<?php echo e(old('etablissement_id')); ?>";
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\carteprofessionnelles\carteprofessionnnelle\resources\views/agents/create.blade.php ENDPATH**/ ?>