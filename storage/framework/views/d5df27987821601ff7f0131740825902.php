...
<!-- RECTO -->
<div class="page">
    <img class="full-bg" src="data:image/png;base64,<?php echo e($recto); ?>" alt="Recto">
    ...
    <img class="cachet" src="data:image/png;base64,<?php echo e($cachet); ?>" alt="Cachet Ministère">
...
<div class="page" style="page-break-after: avoid;">
    <img class="full-bg" src="data:image/png;base64,<?php echo e($verso); ?>" alt="Verso">
