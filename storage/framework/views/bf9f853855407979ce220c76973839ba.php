    ...
    <div class="welcome-hero bg-mfpt-gradient py-6 position-relative overflow-hidden">
        <div class="container text-center text-white position-relative z-index-1">
            <div class="welcome-logo mb-4">
                <img src="<?php echo e(asset('images/mfpt-logo-white.png')); ?>" alt="Logo MFPT" class="img-fluid" style="max-height: 100px;">
            </div>
            ...
            <div class="welcome-badge mb-4">
                <img src="<?php echo e(asset('images/pro-badge.svg')); ?>" alt="Carte Professionnelle" class="img-fluid" style="max-height: 180px;">
            </div>
                    ...
                    <div class="card shadow-lg border-0">
                        <div class="card-body p-4 p-md-5">
                            ...
                            <div class="d-flex flex-column flex-md-row justify-content-center gap-3 mt-4">
                                <a href="<?php echo e(route('login')); ?>" class="btn btn-primary btn-lg px-4 py-3">
                                    <i class="fas fa-sign-in-alt me-2"></i> Connexion personnel
                                </a>
                                <a href="<?php echo e(route('register')); ?>" class="btn btn-outline-primary btn-lg px-4 py-3">
                    ...
                    <div class="card shadow-lg border-0 bg-light-primary">
                        <div class="card-body p-5 text-center">
                            <div class="welcome-avatar mb-4">
                                ...
                                <img src="<?php echo e(Storage::url(Auth::user()->photo)); ?>" alt="Photo profil" class="rounded-circle" style="width: 100px; height: 100px; object-fit: cover;">
                                <?php else: ?>
                            ...
                            <h2 class="h3 mb-3">Bienvenue, <?php echo e(Auth::user()->name); ?></h2>
                            <p class="text-muted mb-4">Vous êtes connecté à la plateforme de gestion des cartes professionnelles</p>

                            <div class="d-flex flex-wrap justify-content-center gap-3">
                                <a href="<?php echo e(route('dashboard')); ?>" class="btn btn-primary btn-lg px-4 py-2">
                                    <i class="fas fa-tachometer-alt me-2"></i> Tableau de bord
                                </a>
                                <a href="<?php echo e(route('card.request')); ?>" class="btn btn-success btn-lg px-4 py-2">
                                    <i class="fas fa-id-card me-2"></i> Ma carte
                                </a>
                                <?php if(Auth::user()->isAdmin()): ?>
                                <a href="<?php echo e(route('admin.dashboard')); ?>" class="btn btn-outline-primary btn-lg px-4 py-2">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\carteprofessionnelles\carteprofessionnnelle\resources\views/welcome.blade.php ENDPATH**/ ?>